...
import {
    ...
    filter_group,
    getActiveItemInBlackNav,
    convertParamsToBigTitleName,
    getTopicForSearchText
} from './consts';

export default function ProductByTopicPage({ match }) {
    let search_text = match.params.topic;
    ...
    useEffect(() => {
        ...
        let topic = getTopicForSearchText(search_text);

        axios.post('/api/products/search-by-topic/' + topic, body, config)
            .then((res) => {
                // console.log('[FETCH-DATA] Data Loaded! (✔)');
    ...
    return (
        <React.Fragment >
            <NavBarSelection activeItem={getActiveItemInBlackNav(search_text)}/>
            <div className="products-by-topic-page main">
                <Search_bar />
                ...
                <div className="main-board">
                    <Controller_Board 
                        ...
                        bigTitleName={convertParamsToBigTitleName[search_text]}
                    />
