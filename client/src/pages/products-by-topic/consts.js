...
function getActiveItemInBlackNav(target) {
    let getActiveItemInBlackNav = {
        'sport-shoes': 'Sport Shoes',
        'man': 'Man',
        'woman': 'Woman'
    }
    let activeItem = getActiveItemInBlackNav[target];
    return activeItem ? getActiveItemInBlackNav[target] : target;
}

function getTopicForSearchText(search_text) {
    let Lib = {
        'sport-shoes': 'sport',
        'man': 'man',
        'woman': 'men'
    }
    let topic = Lib[search_text];
    return topic ? Lib[search_text] : search_text;
}

let convertParamsToBigTitleName = {
    'sport-shoes': 'Sport Shoes',
    'man': 'For Man',
    'woman': 'For Woman'
}
