...
import { register } from "../../../redux-handle/actions/admin/auth";
...
import Lock_icon from '../../../images/img/key.png';
...
export default function AdminRegisterPage() {
    ...
    function checkKeyAdmin() {
        let key_admin = key_admin_input.current.value;

        let check_option = {
            notEmpty: {
                check: true,
                message: "Please fill Key-admin!"
            }
        }
        let error = check(key_admin, check_option);
    ...
    return (
        <div>
            <div className="admin-register">
                <div className="title">Register Admin account!</div>
                ...
                <div className="register-box">
                    ...
                    <div className="key-admin box-input">
                        <img src={Lock_icon} className="icon"/>
                        <input 
                            type="password" 
                            placeholder="Key-Admin"
                            onBlur = {checkKeyAdmin}
                            ref = {key_admin_input}
                            onKeyPress={e => { if (e.key === 'Enter') register_submit() }}
                        />
                    </div>
                    {alert.key_admin.isShow && <AlertError message={alert.key_admin.message}/>}
                ...
                <div className="recommend">
                    <h4>You have an account? <Link to="/admin/login">Log in</Link></h4>
                </div>
